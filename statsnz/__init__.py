...
class StatsNZ:
    ...
    def get_area_layer(self, layer_id, lat, long, key_name):
        """
        Query area layers. This is the primary method to retrieve data based on coordinates.
        """
        try:
    ...
    def get_tla(self, lat, long):
        ...
        return self.get_area_layer(layer_id, lat, long, key_name)
    ...
    def get_custom_layer(self, layer_id, lat, long):
        """
        Retrieve data for a custom layer for the given coordinates.
        """
        return self.get_area_layer(layer_id, lat, long, 'properties')  # Change 'properties' to the actual key if specific field needed
